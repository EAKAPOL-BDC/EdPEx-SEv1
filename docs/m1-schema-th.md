...
การแก้ข้อค้นพบ PR #3 เพิ่ม migrations `0003` และเส้นทางอัปเกรดจาก M1 `0002`
ดู [ตารางข้อค้นพบ วิธีแก้ และ tests](pr3-fixes-th.md) สำหรับสัญญารับรองคำแปลและ population locks ฉบับแก้ไข
...
สคริปต์ migration สร้างฐานใหม่ด้วยชื่อสุ่มสามฐานทุกครั้ง:
...
3. ฐาน M1 เดิมจำลอง: migrate ถึง `0002` ก่อน เพิ่มรุ่นเผยแพร่/คำแปลรับรอง/ประชากร frozen/รอบ open/audit
   แล้วอัปเกรดผ่าน migrations ใหม่ ตรวจทุกคอลัมน์เดิมของข้อมูลธุรกิจว่าคงครบ
