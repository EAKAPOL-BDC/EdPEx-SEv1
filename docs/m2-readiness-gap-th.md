...
> เพิ่ม calculation run/source snapshots และสิทธิ์ภายในต่อแล้ว ดู [รายงานรอบคำนวณ](m2-snapshots-th.md)
> ส่วนรับข้อมูลจริง รับรอง เผยแพร่ และงาน M2 ส่วนอื่นยังไม่ครบ
